...
export default function Dashboard() {
  ...
  const recentSummaries = [
    {
      title: "ReLU",
      date: "Mar 9, 2025",
      summary: "With advances in deep learning and the availability of data and modern computation resources we...."
    },
    {
      title: "ReLU",
      date: "Mar 9, 2025",
  ...
  const handleGistItClick = () => {
    // For PDF files, ensure we're passing the file object directly without modifications
    if (selectedUploadOption === 0 && uploadedFile) {
      navigate('/gistit', { 
        state: { 
          gistData: {
            sourceType: 'file',
            content: uploadedFile,  // Pass the raw File object
            ...
            return (
              <div key={index} className='summary'>
                <div className="titleCard">
                  ...
                  <p className="titleDate baloo-2-regular">{summary.date}</p>
                </div>
